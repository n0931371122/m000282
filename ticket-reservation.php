                            ...
                            <div class="box" data-aos="fade-up">
                                ...
                                <div class="calendar">
                                    <div class="title flex-center position-relative">
                                        ...
                                        <a class="today position-absolute text-center notoSansTC font-16" href="ticket-time-1">今天</a>
                                    </div>
                                    <div class="body">
        ...
        function refreshDate() {
            ...
            for (var i = 1; i <= totalDay; i++) {
                if ((i < my_day && my_year == my_date.getFullYear() && my_month == my_date.getMonth()) || my_year < my_date.getFullYear() || (my_year == my_date.getFullYear() && my_month < my_date.getMonth())) {
                    ...
                    if (!hasAdd) {
                        str += "<li class='today'><a href='ticket-time-1'><span class='day lato font-20 font-weight-bold'>" + i + "</span><span class='d-block notoSansTC'>立即預約</span>" + "</a></li>";
                    }
                } else {
                    var hasAdd = false;
                    ...
                    if (!hasAdd) {
                        str += "<li><a href='ticket-time-1'><span class='day lato font-20 font-weight-bold'>" + i + "</span><span class='d-block notoSansTC'>立即預約</span>" + "</a></li>";
                    }
                }
                count++;
            }
