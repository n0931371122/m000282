                     ...
                     <div class="block pt-4">
                         <div class="box max1500" data-aos="fade-up">
                             <div class="note pb-4 pl-xl-4 pr-xl-2">
                                 <div>
                                     <span class="d-block notoSansTC font-weight-500 les1 mb-2 mb-sm-3 pb-sm-1">活動預約事項：</span>
                                     <ul class="blue-dot-style noneStyle">
                                         <li class="mb-1">有標註『<img class="star" src="styles/images/common/star.svg" alt="雄獅鉛筆廠股份有限公司">』的活動，總預約數量不可超過入園券預約數量。</li>
                                         <li class="mb-1">部分DIY課程及活動預約數量受限，不可超過門票購買數量。如欲加購，請至現場購買。</li>
                                     </ul>
                                 </div>
                                 <a class="info d-table font-16 font-weight-500 text-center" href="news">活動介紹</a>
                             </div>
                             ...
                             <div>
                                 ...
                                 <div class="form">
                                     <div class="notoSansTC pt-sm-3 mb-sm-3 pb-1">
                                         <span class="d-block font-22 font-weight-500 les2 mr-4 pr-2 pl-xl-4 mb-2 mb-sm-0">請選購活動</span>
                                         <p class="les2">已購買<span class="font-weight-500">活動票券</span>數量<span class="text-red mx-2">1</span>張</p>
                                     </div>
                                     <div style="border-bottom:1px solid black;">
                                                 ...
                                                 <table class="w-100 notoSansTC cart-table">
                                                     <thead>
                                                         <tr>
                                                             ...
                                                             <th>地點</th>
                                                             <th class="course-cell-th">活動名稱</th>
                                                             <th>剩餘名額</th>
                                                             <th>數量</th>
                                                             <th>費用(元)</th>
                                                     ...
                                                     <tbody class="discounts-body">
                                                         <tr>
                                                             <td></td>
                                                             <td class="main-discounts" colspan="7">
                                                                 <div>
                                         ...
                                         <div class="total mb-sm-5 pb-sm-3">
                                             <table class="w-100 notoSansTC mt-sm-3">
                                                 <tbody>
                                                     <tr>
                                                         <td>
                                                             消費金額 ( 4筆 )
                                                     ...
                                                     <tr>
                                                         ...
                                                         <td class="font-24 font-weight-500" style="color:#D70084;">
                                                             NT $1900
                                                         </td>
                                                     </tr>
                                                 </tbody>
                                     ...
                                     <div class="btns flex-center">
                                         ...
                                         <a href="course-reservation" class="white-btn font-16 flex-center font-weight-bold h60 w180">課程預約</a>
                                     </div>
                                 </div>
                             </div>
                         </div>
