...
<body>
    <div class="wp member" id="ok-mobile">
            ...
            <div class="inner">
                ...
                <div class="section pt-sm-5 mt-4">
                    ...
                    <div class="block pt-sm-3 max600">
                        ...
                        <div class="box ok flex-center text-center les1" data-aos="fade-up" data-aos-delay="200">
                            <div class="pb-sm-5 mb-sm-5">
                                ...
                                <h3 class="font-30 notoSansTC font-weight-500 mt-2 mt-sm-3 mb-sm-3 pb-2">會員註冊成功</h3>
