...
<body>
    <div class="wp member noTab memberCenter" id="password-ok">
        ...
        <main class="main">
            <div class="inner">
                ...
                <div class="section">
                    ...
                    <h1 class="d-table notoSansTC font-40 mx-auto mb-md-4 pb-md-2" data-aos="fade-up" data-aos-delay="100">會員中心</h1>
                    ...
                    <div class="block max1500 pt-3">
                        ...
                        <div class="box les1 ok flex-center text-center" data-aos="fade-up" data-aos-delay="200">
                            <div class="pb-sm-5 mb-sm-5">
                                <img class="lazyload" src="styles/images/common/preload.png" data-src="styles/images/common/ok.svg" alt="雄獅鉛筆廠股份有限公司">
                                <h3 class="font-30 notoSansTC font-weight-500 mt-2 mt-sm-3 mb-sm-3 pb-2">密碼修改成功</h3>
                                <p class="pb-sm-5 mb-4" style="line-height:1.6em;">您的密碼已修改完成</p>
                                <div class="btns flex-center mb-sm-5">
                                    <a href="orders" class="blue-btn font-16 flex-center font-weight-bold mx-auto">確認</a>
                                </div>
                            </div>
                        </div>
                    </div>
