                    ...
                    <div class="block pt-sm-3 max600">
                        <div class="tabs" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <ul class="noneStyle  clearfix notoSansTC">
                                <li class="active font-weight-500"><span class="flex-center">忘記密碼</span></li>
                            </ul>
                        </div>
                        <div class="box" data-aos="fade-up" data-aos-delay="100">
                            <form action="orders" method="GET" class="pb-2 pb-sm-4">
                                <div class="field-group mb-3">
                                    <label for="password" class="font-20 font-weight-bold mb-2 mb-sm-3">重設新密碼：</label>
                                    <input type="password" name="password" id="password">
                                </div>
                                <div class="field-group mb-3">
                                    <label for="checkPassword" class="font-20 font-weight-bold mb-2 mb-sm-3">確認新密碼：</label>
                                ...
                                <button type="submit" class="button lightblue-bg text-white w-100 font-20 font-weight-bold mb-sm-3">送出</button>
                            </form>
